...
TEST_AI_DICT = {
'description': 'Yolo26 ai framework support', 
'pkg_name': 'nepi_aif_yolo26', 
'if_file_name': 'aif_yolo26_if.py', 
'if_path_name': '/opt/nepi/nepi_engine/share/nepi_aifs', 
'if_module_name': 'aif_yolo26_if', 
'if_class_name': 'Yolo26AIF', 
'models_folder_name': 'yolo26', 
'pkg_name': 'nepi_aif_yolo26',
'node_file_name': 'nepi_ai_yolo26_detection_node.py',  
'active': True
}

TEST_LAUNCH_NAMESPACE = "/nepi/yolo26_test"
TEST_MGR_NAMESPACE = "/nepi/ai_detector_mgr"
TEST_MODELS_LIB_PATH = "/mnt/nepi_storage/ai_models/"


MODEL_FRAMEWORK="yolo26"

class Yolo26AIF(object):
...
if __name__ == '_main_':
    ...
    while nepi_sdk.check_for_node(node_name):
        ...
        nepi_sdk.sleep(2,10)
    Yolo26AIF(TEST_AI_DICT,TEST_LAUNCH_NAMESPACE,TEST_MGR_NAMESPACE,TEST_MODELS_LIB_PATH)
